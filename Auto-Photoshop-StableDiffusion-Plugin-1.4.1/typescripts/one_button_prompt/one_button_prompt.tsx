                ...
                <div>
                    <SpSliderWithLabel
                        ...
                        title={`Higher levels increases complexity and randomness of generated
                            prompt`}
                        label={Locale('Prompt Complexity')}
                    ...
                    <div>
                        <SpMenu
                            title={Locale('subjects')}
                            items={store.data.subjects}
                            label_item={Locale('Select a Subject')}
                    ...
                    <div>
                        <SpMenu
                            title={Locale('artists')}
                            items={store.data.artists}
                            label_item={Locale('Select an Artist')}
                    ...
                    <div>
                        <SpMenu
                            title={Locale('image types')}
                            items={store.data.imagetypes}
                            label_item={Locale('Select an Image Type')}
