            ...
            <div>
                <div style={{ paddingBottom: '5px' }}>
                    <SpSlider
                        ...
                        title={Locale('Resize scale of current selection size')}
                        onInput={(evt: any) => {
                    ...
                    >
                        <sp-label slot="label">{Locale('Resize')}</sp-label>
                        <sp-label
                            class="labelNumber"
                            slot="label"
                            id="lUpscaleSize"
                ...
                <div style={{ paddingBottom: '5px' }}>
                    ...
                    <SpMenu
                        size="m"
                        title={Locale('Upscaler 1')}
                        items={store.data.upscaler_list}
                        label_item={Locale('Select an Upscaler Model')}
