            ...
            return (
                <div>
                    ...
                    <button
                        ...
                        title={Locale('Refresh the ADetailer Extension')}
        ...
        return (
            <div>
                ...
                <SpMenu
                    ...
                    label_item={Locale('Select a ADetailer Model')}
                    // id={'model_list'}
                ...
                ></SpMenu>
                <sp-textarea
                    placeholder={Locale('ADetailer Prompt')}
                ...
                ></sp-textarea>
                <sp-textarea
                    placeholder={Locale('ADetailer Negative Prompt')}
                ...
                <SpSliderWithLabel
                    ...
                    label={Locale('Detection Confidence Threshold %:')}
                ...
                /> */}
                <SpMenu
                    title={Locale('controlnet inpaint model')}
                    items={store.data.controlnet_models}
                    // style="width: 199px; margin-right: 5px"
                    label_item={Locale('Select a ControlNet Model')}
                    // id={'model_list'}
                ...
                <SpSliderWithLabel
                    ...
                    // output_value={this.props.store.data[id]}
                    // title={ui_config[id].label}
                    label={Locale('ControlNet Weight')}
                    slider_type={
