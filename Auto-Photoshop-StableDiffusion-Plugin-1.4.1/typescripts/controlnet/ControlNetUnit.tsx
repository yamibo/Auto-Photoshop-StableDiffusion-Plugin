                        ...
                        >
                            ...
                            <div className="imgButton btnClass">
                                <button
                                    ...
                                    title={Locale('Preview Annotator')}
                                >
                    ...
                    <div>
                        <div>
                            <SpSlider
                                ...
                                title={Locale(
                                    '2 will keep the composition; 0 will allow composition to change'
                                )}
                            >
                                <sp-label slot="label">
                        ...
                        {!pd.model_free && (
                            <div style={{ width: '50%', display: 'flex' }}>
                                ...
                                <SearchableMenu
                                    ...
                                    placeholder={Locale('Select Model')}
