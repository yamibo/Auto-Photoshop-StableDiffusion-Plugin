...
export class Settings extends React.Component<{}> {
    ...
    render() {
        return (
            <div style={{ width: '100%' }}>
                <sp-label>{Locale('ComfyUI Url:')}</sp-label>
                <SpTextfield
                    type="text"
                ...
                <SpMenu
                    title={Locale(
                        'select an interploation method for resizing images'
                    )}
                    items={Object.keys(interpolationMethods)}
                    label_item={Locale('Select Interpolation Method')}
                ...
                <SpMenu
                    title={Locale('select language')}
                    items={['en_US', 'zh_CN']}
                    label_item={Locale('select language')}
                ...
                <div>
                    <sp-checkbox
                        ...
                        title={Locale('image cfg slider for pix2pix mode')}
                    ...
                    <sp-radio-group selected={store.data.extension_type}>
                        ...
                        {[
                            ...
                            return (
                                <sp-radio
                                    key={index}
                                    title={Locale(config[extension_type].title)}
                ...
                <div>
                    <SpSlider
                        ...
                        title={Locale(
                            'clip skip: use 1 for none, 2 for skipping one layer'
                        )}
                    >
                        <sp-label slot="label">
                            {Locale('Clip Skip: ')}
