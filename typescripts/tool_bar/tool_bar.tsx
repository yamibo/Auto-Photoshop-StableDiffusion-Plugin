        ...
        return (
            <div id="_tool_bar_container">
                <button
                    ...
                    title={Locale(
                        'Move and reSize the highlighted layer to fit into the Selection Area'
                    )}
                ...
                <button
                    title={Locale(
                        'create a snapshot of what you see on the canvas and place on a new layer'
                    )}
                ...
                <button
                    ...
                    title={Locale('reset the ui settings to their default values')}
                    style={{ marginRight: '3px' }}
                    onClick={(evt: any) => {
                        try {
                ...
                <button
                    ...
                    id="btnInterrogate"
                    title={Locale(
                        'Interrogate the selected area, convert Image to Prompt'
                    )}
                    style={{ marginRight: '3px' }}
                ...
                <button
                    ...
                    style={{ marginRight: '3px' }}
                    title={Locale(
                        'Reselect the selection area for the current session'
                    )}
                ...
                <button
                    ...
                    title={Locale('Quickly jump to the preview section')}
                ...
                <div id="scrollToControlNetUnitContainer">
                    <button
                        ...
                        title={Locale(
                            'Quickly jump to the active ControlNet Unit'
                        )}
                    >
                        C
                    </button>
                    <button
                        id=""
                        className="btnSquare svgButton"
                        title={Locale('Quickly jump to the History Panel')}
                    ...
                    <button
                        id=""
                        className="btnSquare svgButton"
                        title={Locale('Quickly jump to the Lexica Panel')}
